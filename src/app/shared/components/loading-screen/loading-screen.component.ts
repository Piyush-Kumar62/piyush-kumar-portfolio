...
@Component({
  ...
  template: `
    <div class="loading-screen" role="status" aria-label="Loading portfolio">
      <div class="loader-inner">
        <div class="logo-text">
          <img src="/assets/images/logo.png" alt="Piyush Logo" class="logo-img" />
        </div>
  ...
  styles: [`
    ...
    @keyframes pulseGlow {
      0%, 100% { filter: drop-shadow(0 0 18px rgba(99,102,241,0.45)); }
      50% { filter: drop-shadow(0 0 45px rgba(6,182,212,0.78)); }
    }
